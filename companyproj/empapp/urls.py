...
from .views import show_employees, employees_salary_above1000, employees_born_after1990, employees_avg_salary, name_patterson
...
urlpatterns = [
    ...
    path('name/', name_patterson, name='name_patterson'), 
]